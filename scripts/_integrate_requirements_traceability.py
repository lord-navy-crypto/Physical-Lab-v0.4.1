...
def main() -> int:
    ...
    replace_once(
        ...
        '      "resources/ui/physical_lab_risk_economics_ui.py": "ui/physical_lab_risk_economics_ui.py",\n      "resources/ui/physical_lab_requirements.py": "ui/physical_lab_requirements.py",\n      "resources/ui/physical_lab_requirements_ui.py": "ui/physical_lab_requirements_ui.py",\n      "resources/ui/physical_lab_units.py": "ui/physical_lab_units.py",\n',
    )

    print("Requirements Traceability guarded integration: PASS")
    return 0
