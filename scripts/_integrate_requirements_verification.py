...
def main() -> int:
    ...
    replace_once(
        ...
        "    import physical_lab_risk_economics_ui as risk_economics_ui\n    import physical_lab_requirements_verification_ui as requirements_verification_ui\n",
    )
    replace_once(
        evidence,
        ...
        '            "Evidence-first review across the active .physlab project. Passport, claims, cross-checks, engineering decisions, operations plans, quality/reliability studies, risk/economics studies, requirements/verification plans, snapshots and diffs "\n            "use the same deterministic project state. No aggregate credibility score, machine truth verdict, design verdict, globally optimal schedule, process qualification, risk acceptance, investment recommendation, automatic requirement verification, or certification verdict is produced."\n',
    )
    replace_once(
        evidence,
        ...
        '        passport_tab, claims_tab, cross_tab, decision_tab, operations_tab, quality_tab, risk_economics_tab, requirements_tab, diff_tab = st.tabs([\n            "Credibility Passport", "Claims", "Cross-Checks", "Engineering Decisions", "Operations", "Quality & Reliability", "Risk & Economics", "Requirements & Verification", "Snapshots & Diff"\n        ])\n',
    )
    replace_once(
        evidence,
        '        with risk_economics_tab:\n            risk_economics_ui.render_risk_economics_tab(st, path, profile, refs)\n\n        with diff_tab:\n',
        '        with risk_economics_tab:\n            risk_economics_ui.render_risk_economics_tab(st, path, profile, refs)\n\n        with requirements_tab:\n            requirements_verification_ui.render_requirements_verification_tab(st, path, profile, refs)\n\n        with diff_tab:\n',
    )
    ...
    replace_once(
        ...
        '      "resources/ui/physical_lab_risk_economics_ui.py": "ui/physical_lab_risk_economics_ui.py",\n      "resources/ui/physical_lab_requirements_verification.py": "ui/physical_lab_requirements_verification.py",\n      "resources/ui/physical_lab_requirements_verification_ui.py": "ui/physical_lab_requirements_verification_ui.py",\n      "resources/ui/physical_lab_units.py": "ui/physical_lab_units.py",\n',
    )

    print("Requirements & Verification guarded integration: PASS")
    return 0
